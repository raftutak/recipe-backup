        ...
        <>
          <Container className="mb-4">
            <StyledContainer>
              ...
              <StyledRecipeName>
                <p>Orkiszowe pierogi z twarogiem i suszonymi pomidorami {id}</p>
                <br></br>
              </StyledRecipeName>
              <StyledImage>
                <img
                  src="http://3.bp.blogspot.com/-dD-p9c29nek/UYPuyiJOl0I/AAAAAAAAE20/nmFDVbExdaQ/s640/1.jpg"
                  alt="test"
                />
            ...
            <StyledDescription>
              ...
              <br></br>
              <h4>
                Przed rozwałkowaniem stolnicę należy podsypać obficie mąką.
              </h4>
              ...
              Gotowe pierożki układamy na ściereczce lub posypanej mąką
              stolnicy. Gotujemy około 5 minut w osolonej wodzie (wrzucone na
              wrzątek).
            </StyledDescription>
          </Container>
        </>
